<template>
    <div class="setting-page">
        <div class="form">
            <AddButton title="新增英雄获取方式" @add="add"></AddButton>
        </div>
        ...
        <get-way-new v-model="popupShow" v-if="popupShow" @success="success" type="heroGetWay"
        ...
        methods: {
            ...
            toDelete(row){
                this.$confirm(`是否删除获取方式--${row.name}?`, '提示', {
                    ...
                    await this.$http.delete(`rest/heroGetWay/${row._id}`)
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
                    });
